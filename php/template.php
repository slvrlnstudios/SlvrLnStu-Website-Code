	...
	<div id="content">
		<article>
			...
			<img src="../images/filler.jpg" alt="Image" title="Dummy Image"/>
		...
		<article>
			...
			<img src="../images/filler.jpg" alt="Image" title="Dummy Image"/>
			<p class="aBody">"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium 
